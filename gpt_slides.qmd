...
## Introduction to IP-weighting

- Inverse Probability Weighting (IPW): A method to estimate causal effects by re-weighting the data.
- Purpose: Adjust for confounding by balancing covariates across treatment groups.
- Useful for both point treatment and time-varying treatments.
